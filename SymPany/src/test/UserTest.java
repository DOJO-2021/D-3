...
/*
		...
		User insRec = new User("D3-2","黒クマ次郎","黒クマ","北極3-21-2","株式会社温暖化防止","1998-07-09","北極南大学","素潜り","");
...
*/
		...
		User upRec = new User("D3","白クマ太郎","白クマ","北極3-21-4","株式会社温暖化防止","1998-04-22","北極北大学","魚のつかみ取り","よろしくな");
		if (dao.update(upRec)) {
