...
<br>
SymPanyはそんな<span>コミュニケーションのきっかけ</span>になることを願って生まれました。<br>
<br>
</p>
</div>
<div class="man">
...
<h2>機能説明</h2>
	<div class="menu-item">
		...
		<a id="mypage"><h4>マイページ</h4></a>
			...
			趣味や好きなものを登録して探してもらおう!!<br>
			<br>
			▶<a href="/SymPany/MypageServlet">『マイページ』</a>はこちらから
			</p>
		</div>
	</div>
	...
	<div class="menu-item">
		<div class="menu-text">
			...
			<br>
			▶<a href="/SymPany/ProfileSearchServlet">『プロフィール検索』</a>はこちらから
			</p>
		</div>
	...
	<div class="menu-item">
		...
		<div class="menu-text">
			...
			<br>
			▶<a href="/SymPany/ChatServlet">『チャット』</a>はこちらから
			</p>
		</div>
	</div>
	<div class="menu-item">
		<div class="menu-text">
			...
			<p>
			いつもお疲れ様！またここにきてみんなと話そう！<br>
			<br>
			▶<a href="/SymPany/LogoutServlet">『ログアウト』</a>はこちらから
			</p>
		</div>
		<div class="menu-photo2">
